...
/* harmony import */ var _assets_media_leaderboard_icon_png__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../assets/media/leaderboard-icon.png */ "./src/assets/media/leaderboard-icon.png");
/* harmony import */ var _services_gameId_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./services/gameId.js */ "./src/js/services/gameId.js");




document.getElementById('logo').src = _assets_media_leaderboard_icon_png__WEBPACK_IMPORTED_MODULE_2__;
if (!localStorage.getItem('gameId')) {
  await (0,_services_gameId_js__WEBPACK_IMPORTED_MODULE_3__["default"])();
}
...
/***/ "./src/js/markup-injectors/injectScoresOnDOM.js":
/*!******************************************************!*\
  !*** ./src/js/markup-injectors/injectScoresOnDOM.js ***!
  \******************************************************/
...
/* harmony export */ });
/* harmony import */ var _markup_templates_createTableScoreRows_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../markup-templates/createTableScoreRows.js */ "./src/js/markup-templates/createTableScoreRows.js");

var injectScoresOnDOM = function injectScoresOnDOM(holder, scores) {
  scores.forEach(function (result) {
    holder.innerHTML += (0,_markup_templates_createTableScoreRows_js__WEBPACK_IMPORTED_MODULE_0__["default"])(result);
  });
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (injectScoresOnDOM);

/***/ }),

/***/ "./src/js/markup-templates/createTableScoreRows.js":
/*!*********************************************************!*\
  !*** ./src/js/markup-templates/createTableScoreRows.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var createTableScoreRows = function createTableScoreRows(data) {
  return "<tr>\n    <td>".concat(data.user, " : ").concat(data.score, "</td>\n  </tr>");
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (createTableScoreRows);

/***/ }),

/***/ "./src/js/services/gameId.js":
/*!***********************************!*\
  !*** ./src/js/services/gameId.js ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var gameId = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response, newGameResult, newGameId;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          newGameResult = _context.sent;
          // ? removes 'Game with ID: added.'
          newGameId = newGameResult.result.split(': ')[1].replace(' added.', '');
        ...
        case 13:
          ...
          throw new Error("Failed to create a new game. Error => ".concat(_context.t0));
        case 16:
        case "end":
...
var UserServices = /*#__PURE__*/function () {
  ...
  _createClass(UserServices, [{
    key: "addScore",
    value: function () {
      var _addScore = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return fetch("https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/".concat(this.gameId, "/scores/"), {
                method: 'POST',
                body: JSON.stringify({
                  user: data.user,
                  score: data.score
            ...
            case 5:
              _context.prev = 5;
              _context.t0 = _context["catch"](0);
              console.error("There was an error adding the given score, error => ".concat(_context.t0));
    ...
    key: "getAllScores",
    value: function () {
      var _getAllScores = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var scores, responseData;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 8:
              ...
              return _context2.abrupt("return", responseData.result);
            case 12:
              _context2.prev = 12;
              _context2.t0 = _context2["catch"](0);
              console.error("There was an error fetching scores data, error => ".concat(_context2.t0));
      ...
      function getAllScores() {
        return _getAllScores.apply(this, arguments);
      }
      return getAllScores;
    }()
  }]);
...
document.querySelector('[data-submit-new-score]').addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var userName, userScore, userServices;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        userName = document.querySelector('input[name="name"]');
        userScore = document.querySelector('input[name="score"]');
...
document.querySelector('[data-get-all-scores]').addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
  var scoresHolder, userServices, scores;
  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      case 0:
        if (localStorage.getItem('gameId')) {
        ...
        _context2.next = 3;
        return (0,_services_gameId_js__WEBPACK_IMPORTED_MODULE_3__["default"])();
      case 3:
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_base_normalize_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! -!../../node_modules/css-loader/dist/cjs.js!./base/normalize.css */ "./node_modules/css-loader/dist/cjs.js!./src/styles/base/normalize.css");
// Imports
...
___CSS_LOADER_EXPORT___.push([module.id, "@import url(https://fonts.googleapis.com/css2?family=Lexend+Peta:wght@200;300;400&family=Montserrat:ital,wght@1,700&family=Poppins:wght@300&display=swap);"]);
// Module
...
.form-control:focus {
  ...
  border-color: #1db94c;
  outline: 0;
  box-shadow: 0 0 0 0.25rem #1db94c;
}
...
.btn-success:hover {
  color: #fbfbfb;
  box-shadow: 0 0 0 0.25rem #35495e;
}

.table-striped > tbody tr {
  font-family: "Lexend Peta", sans-serif, monospace;
  font-size: 1rem;
}
...
}`, "",{"version":3,"sources":["webpack://./src/styles/breakpoints/index-breakpoints.scss","webpack://./src/styles/index.scss","webpack://./src/styles/vendor-extensions/bootstrap-overrides.scss","webpack://./src/styles/variables/_variables.scss"],"names":[],"mappings":"AAAA;EACE;IACE,sBAAA;IACA,mBAAA;ECGF;EDAA;IACE,cAAA;IACA,mBAAA;ECEF;AACF;ACTA;EACE,cCFM;EDGN,yBCFU;AFaZ;ACTE;EACE,cCNI;EDOJ,yBCNQ;EDOR,qBCTU;EDUV,UAAA;EACA,iCAAA;ADWJ;;ACPA;EACE,yBChBY;EDiBZ,gBAAA;EACA,cChBU;AF0BZ;ACRE;EACE,cCpBI;EDqBJ,iCAAA;ADUJ;;ACLE;EACE,iDCzBS;ED0BT,eAAA;ADQJ;ACLE;EACE,6BAAA;EACA,mCAAA;ADOJ;ACJE;EACE,oDAAA;EACA,2BAAA;ADMJ;;ACFA;EACE,YAAA;EACA,qBAAA;ADKF;;AA5CA;EACE,wDAAA;EACA,cEPM;AFsDR;;AA5CA;EACE,cAAA;AA+CF;;AA5CA;EACE,iDEbW;EFcX,eAAA;EACA,gBAAA;EACA,cEdK;AF6DP;AA7CE;EANF;IAOI,iBAAA;EAgDF;AACF;;AA7CA;EACE,gBAAA;AAgDF;;AA7CA;EACE,gBAAA;EACA,cE3BK;AF2EP;;AA7CA;EACE,iBAAA;EACA,gBAAA;EACA,kBAAA;AAgDF;AA9CE;EACE,aAAA,EAAA,mCAAA;EACA,cAAA,EAAA,qCAAA;AAgDJ;AA7CE;EACE,eAAA;EACA,mBE1CG;EF2CH,mBAAA;AA+CJ;AA5CE;EAhBF;IAiBI,iBAAA;EA+CF;AACF","sourcesContent":["@media (max-width: 768px) {\n  .main-section {\n    flex-direction: column;\n    align-items: center;\n  }\n\n  .add-score-container {\n    margin: 0 auto;\n    margin-bottom: 2rem;\n  }\n}\n","@import 'base/normalize.css';\n@import 'breakpoints/index-breakpoints.scss';\n@import 'vendor-extensions/bootstrap-overrides.scss';\n@import url('https://fonts.googleapis.com/css2?family=Lexend+Peta:wght@200;300;400&family=Montserrat:ital,wght@1,700&family=Poppins:wght@300&display=swap');\n@import 'variables/variables';\n\nbody {\n  background: linear-gradient(to bottom, $off-black, $fluor-green);\n  color: $white;\n}\n\nmain {\n  overflow: auto;\n}\n\n.main-header {\n  font-family: $lexan-font;\n  font-size: 2rem;\n  font-weight: 900;\n  color: $gold;\n\n  @media (min-width: 768px) {\n    font-size: 2.5rem;\n  }\n}\n\n.logo {\n  max-width: 120px;\n}\n\ninput[name='score'] + span {\n  font-weight: 600;\n  color: $gold;\n}\n\n.table-container {\n  max-height: 420px;\n  max-width: 350px;\n  overflow-x: hidden;\n\n  &::-webkit-scrollbar {\n    width: 0.6rem; /* Mostly for vertical scrollbars */\n    height: 0.7rem; /* Mostly for horizontal scrollbars */\n  }\n\n  &::-webkit-scrollbar-thumb {\n    /* Foreground */\n    background: $gold;\n    border-radius: 1rem;\n  }\n\n  @media (max-width: 768px) {\n    max-height: 200px;\n  }\n}\n","@import '../variables/variables';\n\n.form-control {\n  color: $white;\n  background-color: $off-black;\n\n  &:focus {\n    color: $white;\n    background-color: $off-black;\n    border-color: $fluor-green;\n    outline: 0;\n    box-shadow: 0 0 0 0.25rem $fluor-green;\n  }\n}\n\n.btn-success {\n  background-color: $fluor-green;\n  font-weight: 700;\n  color: $off-black;\n\n  &:hover {\n    color: $white;\n    box-shadow: 0 0 0 0.25rem $blue;\n  }\n}\n\n.table-striped > tbody {\n  tr {\n    font-family: $lexan-font;\n    font-size: 1rem;\n  }\n\n  tr:nth-of-type(odd) > * {\n    --bs-table-color-type: $white;\n    --bs-table-bg-type: rgb(24, 24, 24);\n  }\n\n  tr:nth-of-type(even) > * {\n    --bs-table-color-type: var(--bs-table-striped-color);\n    --bs-table-bg-type: #1db94c;\n  }\n}\n\n.table-striped > tbody > tr > td {\n  border: none;\n  border-radius: 0.3rem;\n}\n","$fluor-green: #1db94c;\n$white: #fbfbfb;\n$off-black: #101010;\n$lexan-font: 'Lexend Peta', sans-serif, monospace;\n$blue: #35495e;\n$gold: #f0c518;\n"],"sourceRoot":""}]);
// Exports
...
/***/ "./node_modules/css-loader/dist/cjs.js!./src/styles/base/normalize.css":
/*!*****************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./src/styles/base/normalize.css ***!
  \*****************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/assets/media/leaderboard-icon.png":
/*!***********************************************!*\
  !*** ./src/assets/media/leaderboard-icon.png ***!
  \***********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "leaderboard-icon.png";
...
/******/ })()
;
//# sourceMappingURL=bundle.76c5d8994995fe7195d3.js.map